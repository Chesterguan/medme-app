...
/// 加密 payload 的 `consent` 字段(医生代拍病人纸质材料流程)。严格加法:
...
mod tests {
    ...
    /// 医生代拍流程:`build_encrypted_share_with_consent` 应把同意记录逐字段写进
    /// payload.consent,供医生/病人事后核对「谁、何时、以何种方式同意」。
    #[test]
